...
const PATH_N_FORMATION_DIPLOME = path.join(__dirname, "../../logic/assets/bcnTables/n_formation_diplome.csv");
const PATH_V_FORMATION_DIPLOME = path.join(__dirname, "../../logic/assets/bcnTables/v_formation_diplome.csv");
const PATH_NIVEAU_FORMATION_DIPLOME = path.join(
  __dirname,
  "../../logic/assets/bcnTables/n_niveau_formation_diplome.csv"
);
const PATH_SPECIALITE = path.join(__dirname, "../../logic/assets/bcnTables/n_lettre_specialite.csv");
const PATH_N_MEF = path.join(__dirname, "../../logic/assets/bcnTables/n_mef.csv");
const PATH_N_DISPOSITIF_FORMATION = path.join(__dirname, "../../logic/assets/bcnTables/n_dispositif_formation.csv");
