...
describe(__filename, () => {
  // it.skip("Vérifie que on récupere les informations BCN d'un code formation diplome 8 Caracteres", async () => {
  ...
  // it.skip("Vérifie que on récupere les détails de la spécialité d'un code formation diplome 9 Caracteres", async () => {
  ...
  it("Doit toujours retourner un tableau de rncps", async () => {
    assert.deepStrictEqual(await getDataFromCfd("32321014"), {
      result: {
        cfd: "32321014",
        cfd_outdated: false,
