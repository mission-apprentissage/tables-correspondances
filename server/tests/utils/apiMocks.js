...
const ApiSirene = require("../../src/common/apis/ApiSirene");
const ApiEsSup = require("../../src/common/apis/ApiEsSup");
const ApiGeoAdresse = require("../../src/common/apis/ApiGeoAdresse");
const ApiCatalogue = require("../../src/common/apis/ApiCatalogue");
...
module.exports = {
  getMockedApiCatalogue(callback, options = {}) {
    ...
    return new ApiCatalogue({ axios: instance });
  },
  getMockedApiGeoAddresse(callback, options = {}) {
    let instance = axios.create(options);
    options.debug && debug(instance);
    ...
    let mock = new MockAdapter(instance);
    callback(mock, responses);
    return new ApiGeoAdresse({ axios: instance });
  },
  getMockedApiEsSup(callback, options = {}) {
    let instance = axios.create(options);
    options.debug && debug(instance);
    ...
    let mock = new MockAdapter(instance);
    callback(mock, responses);
    return new ApiEsSup({ axios: instance });
  },
  getMockedApiSirene(callback, options = {}) {
    let instance = axios.create(options);
    options.debug && debug(instance);
    ...
    let mock = new MockAdapter(instance);
    callback(mock, responses);
    return new ApiSirene({ axios: instance });
  },
};
